...
exports.draw_card = exports.get_game = exports.join_game = exports.create_game = void 0;

var _mithril = _interopRequireDefault(require("mithril"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var BASE_URL = "development" === 'development' ? 'http://localhost:4567' : 'https://catan-aktwynnwda-uc.a.run.app';

var create_game = function create_game(type) {
  return _mithril.default.request({
    method: 'POST',
    url: "".concat(BASE_URL, "/games"),
    params: {
      type: type
    }
  });
...
var join_game = function join_game(code, player) {
  return _mithril.default.request({
    method: 'PATCH',
    url: "".concat(BASE_URL, "/games/").concat(code, "?player=").concat(player)
  });
};

exports.join_game = join_game;

var get_game = function get_game(code) {
  return _mithril.default.request({
    method: 'GET',
    url: "".concat(BASE_URL, "/games/").concat(code)
  });
};

exports.get_game = get_game;

var draw_card = function draw_card(code, player) {
  return _mithril.default.request({
    method: 'GET',
    url: "".concat(BASE_URL, "/games/").concat(code, "/draw?player=").concat(player)
  });
};

exports.draw_card = draw_card;
},{"mithril":"../node_modules/mithril/index.js"}],"js/text_input.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(data, callback) {
  return function (name) {
    var key_event = function key_event(e) {
...
},{}],"js/flash.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(message) {
  if ((message === null || message === void 0 ? void 0 : message.length) !== 0) return (0, _mithril.default)('p.error', message);
  return null;
};

exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js"}],"js/home.js":[function(require,module,exports) {
"use strict";
...
var _text_input = _interopRequireDefault(require("./text_input"));
...
var _default = function _default() {
  var error = _mithril.default.route.param('error');

  var data = {
    game_code: _jsCookie.default.get('last_game')
  };

  var create_game = function create_game(type) {
    return function () {
      api.create_game(type).then(function (game) {
        return reroute_to_join(game.code);
      });
    };
  };

  var reroute_to_join = function reroute_to_join(code) {
    _jsCookie.default.set('last_game', code);

    _mithril.default.route.set("/game/".concat(code, "/join"));
  };
  ...
  var key_events = (0, _text_input.default)(data, function () {
    return reroute_to_join(data.game_code);
  });
  return {
    view: function view() {
      return (0, _mithril.default)('main', [(0, _mithril.default)('header', [(0, _mithril.default)('h1', 'Dev Cards'), (0, _flash.default)(error)]), (0, _mithril.default)('section', [(0, _mithril.default)('h2', 'Join a game'), (0, _mithril.default)('input', _objectSpread({
        type: 'text',
        placeholder: 'GAME CODE'
      }, key_events('game_code'), {
        value: data.game_code
      })), (0, _mithril.default)('button', {
        onclick: onclick
      }, 'Play')]), (0, _mithril.default)('section', [(0, _mithril.default)('h2', '...or start a new game'), (0, _mithril.default)('button', {
        onclick: create_game('original')
      }, 'New Original Deck'), (0, _mithril.default)('button', {
        onclick: create_game('expansion')
      }, 'New Expansion Deck')])]);
    }
  };
};
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","js-cookie":"../node_modules/js-cookie/src/js.cookie.js","./api":"js/api.js","./text_input":"js/text_input.js","./flash":"js/flash.js"}],"js/code_chip.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(code) {
  return (0, _mithril.default)('.chip', ["Game Code: ", (0, _mithril.default)('span', code)]);
};

exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js"}],"js/join.js":[function(require,module,exports) {
"use strict";
...
var _code_chip = _interopRequireDefault(require("./code_chip"));
...
var _default = function _default() {
  ...
  var code = _mithril.default.route.param('code');

  var data = {
    player: _jsCookie.default.get(code)
  };

  var reroute_to_game = function reroute_to_game(code, player) {
    _jsCookie.default.set(code, player);

    _mithril.default.route.set("/game/".concat(code));
  };

  var join = function join() {
    api.join_game(code, data.player).then(function () {
      _jsCookie.default.set(code, data.player);
  ...
  var key_events = (0, _text_input.default)(data, join);
  ...
  return {
    oninit: function oninit() {
      api.get_game(code).catch(function (err) {
        if (err.code === 404) _mithril.default.route.set('/', {
    ...
    view: function view() {
      return (0, _mithril.default)('main', [(0, _mithril.default)('header', [(0, _mithril.default)('h1', 'Dev Cards'), (0, _flash.default)(error), (0, _code_chip.default)(code)]), (0, _mithril.default)('section', [(0, _mithril.default)('h4', 'Join Game'), (0, _mithril.default)('input', _objectSpread({
        type: 'text',
        placeholder: 'NAME'
      }, key_events('player'))), (0, _mithril.default)('button', {
        placeholder: 'NAME',
        onclick: onclick
      }, 'Join')])]);
    }
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","js-cookie":"../node_modules/js-cookie/src/js.cookie.js","./api":"js/api.js","./text_input":"js/text_input.js","./code_chip":"js/code_chip.js","./flash":"js/flash.js"}],"../../../.config/yarn/global/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"../../../.config/yarn/global/node_modules/buffer/index.js"}],"js/game.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  ...
  var player = _jsCookie.default.get(code);

  var error = null;
  var remaining = null;
  var player_counts = [];
  var draw_enabled = true; // Draws a card

  var onclick = function onclick() {
    draw_enabled = false;
    api.draw_card(code, player).then(function (_ref) {
      var card = _ref.card;
      return alert("You drew a ".concat(card, "!"));
    }).then(update).then(function () {
      return draw_enabled = true;
    });
  }; // Updates game info


  var update = function update() {
    api.get_game(code).then(function (game) {
      remaining = game.remaining;
      player_counts = game.player_counts;
    }).catch(function (_ref2) {
      var response = _ref2.response;
      return _mithril.default.route.set('/', {
  ...
  return {
    oninit: function oninit() {
      ...
      if (!player) _mithril.default.route.set("/game/".concat(code, "/join"), {
    ...
    view: function view() {
      return (0, _mithril.default)('main', [(0, _mithril.default)('header', [(0, _mithril.default)('h1', 'Dev Cards'), (0, _code_chip.default)(code), (0, _flash.default)(error)]), (0, _mithril.default)('section', [(0, _mithril.default)('p', "Hi ".concat(player, "!")), (0, _mithril.default)('p', "Dev cards remaining: ".concat(remaining)), (0, _mithril.default)('button', {
        onclick: onclick,
        disabled: !draw_enabled || remaining === 0
      }, 'Draw a card')]), (0, _mithril.default)('section', [(0, _mithril.default)('div', [(0, _mithril.default)('p', 'Player Counts')].concat(_toConsumableArray(_lodash.default.map(player_counts, function (count, player) {
        return (0, _mithril.default)('p', "".concat(player, ": ").concat(count));
      }))))])]);
    }
  };
};
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","lodash":"../node_modules/lodash/lodash.js","./api":"js/api.js","js-cookie":"../node_modules/js-cookie/src/js.cookie.js","./code_chip":"js/code_chip.js","./flash":"js/flash.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _join = _interopRequireDefault(require("./js/join"));
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _mithril.default.route(root, '/', {
    '/': _home.default,
    '/game/:code/join': _join.default,
    '/game/:code': _game.default
  });
});
},{"mithril":"../node_modules/mithril/index.js","./js/home":"js/home.js","./js/join":"js/join.js","./js/game":"js/game.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
