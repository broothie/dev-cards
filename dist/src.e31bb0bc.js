...
var _default = function _default(code) {
  return (0, _mithril.default)('.chip', ["Game: ", (0, _mithril.default)('span', code)]);
};
...
var _default = function _default() {
  ...
  return {
    ...
    view: function view() {
      return (0, _mithril.default)('main', [(0, _mithril.default)('header', [(0, _mithril.default)('h1', 'Dev Cards'), (0, _code_chip.default)(code), (0, _flash.default)(error)]), (0, _mithril.default)('section', [(0, _mithril.default)('h4', "Hi ".concat(player, "!")), (0, _mithril.default)('p', "Dev cards remaining: ".concat(remaining)), (0, _mithril.default)('button', {
        onclick: onclick,
        disabled: !draw_enabled || remaining === 0
      }, 'Draw a card')]), (0, _mithril.default)('section', [(0, _mithril.default)('h4', 'Card Counts')].concat(_toConsumableArray(_lodash.default.map(player_counts, function (count, player) {
