...
exports.draw_card = exports.get_game = exports.new_game = void 0;
...
var new_game = function new_game(type) {
...
var draw_card = function draw_card(code) {
  return _mithril.default.request({
    method: 'GET',
    url: "".concat(BASE_URL, "/games/").concat(code, "/draw")
  });
};
...
var _default = function _default() {
  ...
  var create_game = function create_game(type) {
    return function () {
      (0, _api.new_game)(type).then(function (game) {
        return _mithril.default.route.set("/game/".concat(game.code));
      });
    };
  };

  var load_game = function load_game() {
    (0, _api.get_game)(game_code).then(function (game) {
      return _mithril.default.route.set("/game/".concat(game.code));
    });
  };
  ...
  var oninput = onkeydown;
  var onchange = onkeydown;
  return {
    view: function view() {
      return (0, _mithril.default)('div', [(0, _mithril.default)('h1', 'Catan Dev Card Deck Simulator'), (0, _mithril.default)('div', [(0, _mithril.default)('div', [(0, _mithril.default)('h2', 'Start a new game'), (0, _mithril.default)('button', {
        onclick: create_game('original')
      }, 'New Original Deck'), (0, _mithril.default)('button', {
        onclick: create_game('expansion')
      }, 'New Expansion Deck')]), (0, _mithril.default)('div', [(0, _mithril.default)('h2', '...or join a game'), (0, _mithril.default)('input', {
        type: 'text',
        placeholder: 'abc123',
        onkeydown: onkeydown,
        oninput: oninput,
...
},{"mithril":"../node_modules/mithril/index.js","./api":"js/api.js"}],"js/game.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  ...
  var onclick = function onclick() {
    (0, _api.draw_card)(code).then(function (data) {
      return alert("You drew a ".concat(data.card, "!"));
    }).then(update);
  };

  var update = function update() {
    (0, _api.get_game)(code).then(function (game) {
      return remaining = game.remaining;
    });
  };

  return {
    oninit: function oninit() {
      update(); // interval = setInterval(update, 1000 / 2);
    },
    onremove: function onremove() {
      clearInterval(interval);
    },
    view: function view() {
      return (0, _mithril.default)('div', [(0, _mithril.default)('h1', "Game ".concat(code)), (0, _mithril.default)('p', "Dev cards remaining: ".concat(remaining)), (0, _mithril.default)('button', {
        onclick: onclick
      }, 'Draw a card')]);
    }
  };
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","./api":"js/api.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"mithril":"../node_modules/mithril/index.js","./js/home":"js/home.js","./js/game":"js/game.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
