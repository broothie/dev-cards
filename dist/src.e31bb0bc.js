...
var join_game = function join_game(code, player) {
  return _mithril.default.request({
    method: 'POST',
    url: "".concat(BASE_URL, "/games/").concat(code, "/join?player=").concat(player)
  });
};

exports.join_game = join_game;

var get_game = function get_game(code, player) {
  return _mithril.default.request({
    method: 'GET',
...
var _default = function _default() {
  ...
  var create_game = function create_game(type) {
    return function () {
      api.create_game(type).then(function (_ref) {
        var code = _ref.code;
        return _mithril.default.route.set("/game/".concat(code, "/join"));
      });
    };
  };

  var reroute_to_join = function reroute_to_join() {
    return _mithril.default.route.set("/game/".concat(data.game_code, "/join"));
  };
  ...
  var key_events = (0, _text_input.default)(data, reroute_to_join);
  return {
    view: function view() {
      return (0, _mithril.default)('div', [(0, _mithril.default)('h1', 'Catan Dev Card Deck Simulator'), (0, _mithril.default)('div', [(0, _mithril.default)('div', [error && (0, _mithril.default)('p', {
        style: 'color:red;'
      }, error), (0, _mithril.default)('h2', 'Join a game'), (0, _mithril.default)('input', _objectSpread({
        type: 'text',
        placeholder: 'GAME CODE'
      }, key_events('game_code'))), (0, _mithril.default)('span', ' '), (0, _mithril.default)('button', {
        onclick: onclick
      }, 'Play')]), (0, _mithril.default)('div', [(0, _mithril.default)('h2', '...or start a new game'), (0, _mithril.default)('button', {
        onclick: create_game('original')
      }, 'New Original Deck'), (0, _mithril.default)('span', ' '), (0, _mithril.default)('button', {
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","./api":"js/api.js","./text_input":"js/text_input.js"}],"../node_modules/js-cookie/src/js.cookie.js":[function(require,module,exports) {
var define;
/*!
...
var _default = function _default() {
  ...
  if (!code) _mithril.default.route.set('/');
  ...
  var update = function update() {
    api.get_game(code, data.player).then(function () {
  ...
  return {
    view: function view() {
      return (0, _mithril.default)('div', [(0, _mithril.default)('h2', ['Join Game ', (0, _mithril.default)('span', {
        style: 'font-family:monospace;'
      }, code)]), error && (0, _mithril.default)('p', {
        style: 'color:red;'
      }, error), (0, _mithril.default)('input', _objectSpread({
        type: 'text',
        placeholder: 'NAME'
      }, key_events('player'))), (0, _mithril.default)('span', ' '), (0, _mithril.default)('button', {
        placeholder: 'NAME',
        onclick: onclick
      }, 'Join')]);
    }
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","js-cookie":"../node_modules/js-cookie/src/js.cookie.js","./api":"js/api.js","./text_input":"js/text_input.js"}],"../../../.config/yarn/global/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
var _default = function _default() {
  ...
  var update = function update() {
    api.get_game(code, player).then(function (game) {
  ...
  return {
    ...
    view: function view() {
      return (0, _mithril.default)('div', [(0, _mithril.default)('p', ['Game code: ', (0, _mithril.default)('span', {
        style: 'font-family:monospace;'
      }, code)]), (0, _mithril.default)('p', "Hi ".concat(player, "!")), (0, _mithril.default)('p', "Dev cards remaining: ".concat(remaining)), (0, _mithril.default)('button', {
        onclick: onclick,
        disabled: !draw_enabled || remaining === 0
      }, 'Draw a card'), (0, _mithril.default)('br'), (0, _mithril.default)('br'), (0, _mithril.default)('br'), (0, _mithril.default)('div', [(0, _mithril.default)('p', 'Player Counts')].concat(_toConsumableArray(_lodash.default.map(player_counts, function (count, player) {
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","lodash":"../node_modules/lodash/lodash.js","./api":"js/api.js","js-cookie":"../node_modules/js-cookie/src/js.cookie.js"}],"index.js":[function(require,module,exports) {
"use strict";
